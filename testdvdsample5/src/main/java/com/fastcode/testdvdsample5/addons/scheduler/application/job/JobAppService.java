package com.fastcode.testdvdsample5.addons.scheduler.application.job;

import com.fastcode.testdvdsample5.Testdvdsample5Application;
import com.fastcode.testdvdsample5.addons.scheduler.CGenClassLoader;
import com.fastcode.testdvdsample5.addons.scheduler.application.job.dto.*;
import com.fastcode.testdvdsample5.addons.scheduler.constants.QuartzConstants;
import com.fastcode.testdvdsample5.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.testdvdsample5.addons.scheduler.domain.job.JobEntity;
import com.fastcode.testdvdsample5.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.testdvdsample5.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.testdvdsample5.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.testdvdsample5.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = Testdvdsample5Application.class.getResource("/").toURI();
